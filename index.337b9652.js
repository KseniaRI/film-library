 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Et(e){return 1e3*Number(e)}function Tt(e){const[t,n,i]=e.split(".");if(void 0===t||void 0===n||void 0===i)return Qe("JWT malformed, contained fewer than 3 sections"),null;try{const e=g(n);return e?JSON.parse(e):(Qe("Failed to decode base64 JWT payload"),null)}catch(e){return Qe("Caught error parsing JWT payload as JSON",e),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(jt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ft(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(zt(t))return"Blackberry";if(Ht(t))return"Webos";if(qt(t))return"Safari";if((t.includes("chrome/")||Bt(t))&&!t.includes("edge/"))return"Chrome";if(Wt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ft(e=w()){return/firefox\//i.test(e)}function qt(e=w()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Bt(e=w()){return/crios\//i.test(e)}function jt(e=w()){return/iemobile/i.test(e)}function Wt(e=w()){return/android/i.test(e)}function zt(e=w()){return/blackberry/i.test(e)}function Ht(e=w()){return/webos/i.test(e)}function Vt(e=w()){return/iphone|ipad|ipod/i.test(e)}function $t(){return E()&&10===document.documentMode}function Yt(e=w()){return Vt(e)||Wt(e)||Ht(e)||zt(e)||/windows phone/i.test(e)||jt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn extends Tn{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Sn.type="SESSION";const Nn=Sn;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er extends Ir{static getInstance(){return new Er}getInitialEvent(e){return h("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||b()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function bs(e){return{type:"value",snapshotNode:e}}function Cs(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Is(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Es(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{operationForChild(e){if(Lr(this.path)){const t=this.children.subtree(new Tr(e));return t.isEmpty()?null:t.value?new zs(this.source,kr(),t.value):new Hs(this.source,kr(),t)}return h(xr(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Hs(this.source,Nr(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fs.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class No{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Vs(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Eo(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Xs(this.viewCache_),r=Io(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let na=1;class ia{constructor(e){this.listenProvider_=e,this.syncPointTree_=new eo(null),this.pendingWriteTree_={visibleWrites:to.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ra(e,t,n,i,r){return function(e,t,n,i,r){h(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=no(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?ha(e,new zs({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function sa(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(po(e.pendingWriteTree_,t)){let t=new eo(null);return null!=i.snap?t=t.set(kr(),!0):Zi(i.children,(e=>{t=t.set(new Tr(e),!0)})),ha(e,new js(i.path,t,n))}return[]}function oa(e,t,n){return ha(e,new zs({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function aa(e,t,n,i){const r=t._path,s=e.syncPointTree_.get(r);let o=[];if(s&&("default"===t._queryIdentifier||Zo(s,t))){const a=Go(s,t,n,i);0===s.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(r));const c=a.removed;o=a.events;const l=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),h=e.syncPointTree_.findOnPath(r,((e,t)=>ea(t)));if(l&&!h){const t=e.syncPointTree_.subtree(r);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&ea(t)){return[ta(t)]}{let e=[];return t&&(e=Jo(t)),Zi(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=fa(e,i);e.listenProvider_.startListening(va(r),pa(e,r),s.hashFn,s.onComplete)}}}if(!h&&c.length>0&&!i)if(l){const n=null;e.listenProvider_.stopListening(va(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(ma(t));e.listenProvider_.stopListening(va(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ma(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return o}function ca(e,t,n){const i=t._path;let r=null,s=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Dr(e,i);r=r||Qo(t,n),s=s||ea(t)}));let o,a=e.syncPointTree_.get(i);if(a?(s=s||ea(a),r=r||Qo(a,kr())):(a=new Vo,e.syncPointTree_=e.syncPointTree_.set(i,a)),null!=r)o=!0;else{o=!1,r=ps.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Qo(t,kr());n&&(r=r.updateImmediateChild(e,n))}))}const c=Zo(a,t);if(!c&&!t._queryParams.loadsAllData()){const n=ma(t);h(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=na++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let l=Ko(a,t,n,fo(e.pendingWriteTree_,i),r,o);if(!c&&!s){const n=Xo(a,t);l=l.concat(function(e,t,n){const i=t._path,r=pa(e,t),s=fa(e,n),o=e.listenProvider_.startListening(va(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)h(!ea(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Lr(e)&&t&&ea(t))return[ta(t).query];{let e=[];return t&&(e=e.concat(Jo(t).map((e=>e.query)))),Zi(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(va(i),pa(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return l}function la(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Qo(n,Dr(e,t));if(i)return i}));return yo(i,t,r,n,!0)}function ha(e,t){return ua(t,e.syncPointTree_,null,fo(e.pendingWriteTree_,kr()))}function ua(e,t,n,i){if(Lr(e.path))return da(e,t,n,i);{const r=t.get(kr());null==n&&null!=r&&(n=Qo(r,kr()));let s=[];const o=xr(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=To(i,o);s=s.concat(ua(a,c,e,t))}return r&&(s=s.concat($o(r,e,i,n))),s}}function da(e,t,n,i){const r=t.get(kr());null==n&&null!=r&&(n=Qo(r,kr()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=To(i,t),c=e.operationForChild(t);c&&(s=s.concat(da(c,r,o,a)))})),r&&(s=s.concat($o(r,e,i,n))),s}function fa(e,t){const n=t.query,i=pa(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||ps.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=ga(e,n);if(i){const n=_a(i),r=n.path,s=n.queryId,o=Dr(r,t);return ya(e,r,new Ws(Bs(s),o))}return[]}(e,n._path,i):function(e,t){return ha(e,new Ws({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return aa(e,n,null,i)}}}}function pa(e,t){const n=ma(t);return e.queryToTagMap.get(n)}function ma(e){return e._path.toString()+"$"+e._queryIdentifier}function ga(e,t){return e.tagToQueryMap.get(t)}function _a(e){const t=e.indexOf("$");return h(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Tr(e.substr(0,t))}}function ya(e,t,n){const i=e.syncPointTree_.get(t);h(i,"Missing sync point for query tag that we're tracking");return $o(i,n,fo(e.pendingWriteTree_,t),null)}function va(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(h(Ho,"Reference.ts has not been loaded"),Ho)(e._repo,e._path):e}class wa{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new wa(t)}node(){return this.node_}constructor(e){this.node_=e}}class ba{getImmediateChild(e){const t=Or(this.path_,e);return new ba(this.syncTree_,t)}node(){return la(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const Ca=function(e,t,n){return e&&"object"==typeof e?(h(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Ia(e[".sv"],t,n):"object"==typeof e[".sv"]?Ea(e[".sv"],t):void h(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Ia=function(e,t,n){if("timestamp"===e)return n.timestamp;h(!1,"Unexpected server value: "+e)},Ea=function(e,t,n){e.hasOwnProperty("increment")||h(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&h(!1,"Unexpected increment value: "+i);const r=t.node();if(h(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const s=r.getValue();return"number"!=typeof s?i:s+i},Ta=function(e,t,n,i){return xa(t,new ba(n,e),i)},ka=function(e,t,n){return xa(e,new wa(t),n)};function xa(e,t,n){const i=e.getPriority().val(),r=Ca(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=Ca(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new ss(s,gs(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new ss(r))),i.forEachChild(os,((e,i)=>{const r=xa(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Na(e,t){let n=t instanceof Tr?t:new Tr(t),i=e,r=xr(n);for(;null!==r;){const e=D(i.node.children,r)||{children:{},childCount:0};i=new Sa(r,i,e),n=Nr(n),r=xr(n)}return i}function Ra(e){return e.node.value}function Pa(e,t){e.node.value=t,Ma(e)}function Aa(e){return e.node.childCount>0}function Oa(e,t){Zi(e.node.children,((n,i)=>{t(new Sa(n,e,i))}))}function La(e,t,n,i){n&&!i&&t(e),Oa(e,(e=>{La(e,t,!0,i)})),n&&i&&t(e)}function Da(e){return new Tr(null===e.parent?e.name:Da(e.parent)+"/"+e.name)}function Ma(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===Ra(e)&&!Aa(e)}(n),r=L(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,Ma(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,Ma(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Ua=/[\[\].#$\/\u0000-\u001F\u007F]/,Fa=/[\[\].#$\u0000-\u001F\u007F]/,qa=function(e){return"string"==typeof e&&0!==e.length&&!Ua.test(e)},Ba=function(e){return"string"==typeof e&&0!==e.length&&!Fa.test(e)},ja=function(e,t,n,i){i&&void 0===t||Wa(Y(e,"value"),t,n)},Wa=function(e,t,n){const i=n instanceof Tr?new Fr(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Br(i));if("function"==typeof t)throw new Error(e+"contains a function "+Br(i)+" with contents = "+t.toString());if(Yi(t))throw new Error(e+"contains "+t.toString()+" "+Br(i));if("string"==typeof t&&t.length>10485760/3&&G(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Br(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(Zi(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!qa(t)))throw new Error(e+" contains an invalid key ("+t+") "+Br(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=G(a),qr(o),Wa(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=G(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+Br(i)+" in addition to actual children.")}},za=function(e,t,n,i){if(!(i&&void 0===n||Ba(n)))throw new Error(Y(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ha=function(e,t){if(".info"===xr(t))throw new Error(e+" failed = Can't modify data under /.info/")},Va=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!qa(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Ba(e)}(n))throw new Error(Y(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class $a{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ya(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Mr(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Ka(e,t,n){Ya(e,n),Ja(e,(e=>Mr(e,t)))}function Ga(e,t,n){Ya(e,n),Ja(e,(e=>Ur(e,t)||Ur(t,e)))}function Ja(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Qa(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Qa(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qi&&Wi("event: "+n.toString()),ir(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new $a,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Os(),this.transactionQueueTree_=new Sa,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function Za(e,t,n){if(e.stats_=pr(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Ps(e.repoInfo_,((t,n,i,r)=>{nc(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>ic(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{R(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Wr(e.repoInfo_,t,((t,n,i,r)=>{nc(e,t,n,i,r)}),(t=>{ic(e,t)}),(t=>{!function(e,t){Zi(t,((t,n)=>{rc(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return fr[n]||(fr[n]=t()),fr[n]}(e.repoInfo_,(()=>new Us(e.stats_,e.server_))),e.infoData_=new As,e.infoSyncTree_=new ia({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=oa(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),rc(e,"connected",!1),e.serverSyncTree_=new ia({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);Ga(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function ec(e){const t=e.infoData_.getNode(new Tr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function tc(e){return(t=(t={timestamp:ec(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function nc(e,t,n,i,r){e.dataUpdateCount++;const s=new Tr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=U(n,(e=>gs(e)));o=function(e,t,n,i){const r=ga(e,i);if(r){const i=_a(r),s=i.path,o=i.queryId,a=Dr(s,t),c=eo.fromObject(n);return ya(e,s,new Hs(Bs(o),a,c))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=gs(n);o=function(e,t,n,i){const r=ga(e,i);if(null!=r){const i=_a(r),s=i.path,o=i.queryId,a=Dr(s,t);return ya(e,s,new zs(Bs(o),a,n))}return[]}(e.serverSyncTree_,s,t,r)}else if(i){const t=U(n,(e=>gs(e)));o=function(e,t,n){const i=eo.fromObject(n);return ha(e,new Hs({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=gs(n);o=oa(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=fc(e,s)),Ga(e.eventQueue_,a,o)}function ic(e,t){rc(e,"connected",t),!1===t&&function(e){lc(e,"onDisconnectEvents");const t=tc(e),n=Os();Ds(e.onDisconnect_,kr(),((i,r)=>{const s=Ta(i,r,e.serverSyncTree_,t);Ls(n,i,s)}));let i=[];Ds(n,kr(),((t,n)=>{i=i.concat(oa(e.serverSyncTree_,t,n));const r=yc(e,t);fc(e,r)})),e.onDisconnect_=Os(),Ga(e.eventQueue_,kr(),i)}(e)}function rc(e,t,n){const i=new Tr("/.info/"+t),r=gs(n);e.infoData_.updateSnapshot(i,r);const s=oa(e.infoSyncTree_,i,r);Ga(e.eventQueue_,i,s)}function sc(e){return e.nextWriteId_++}function oc(e,t,n,i,r){lc(e,"set",{path:t.toString(),value:n,priority:i});const s=tc(e),o=gs(n,i),a=la(e.serverSyncTree_,t),c=ka(o,a,s),l=sc(e),h=ra(e.serverSyncTree_,t,c,l,!0);Ya(e.eventQueue_,h),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||$i("set at "+t+" failed: "+n);const o=sa(e.serverSyncTree_,l,!s);Ga(e.eventQueue_,t,o),hc(e,r,n,i)}));const u=yc(e,t);fc(e,u),Ga(e.eventQueue_,u,[])}function ac(e,t,n){let i;i=".info"===xr(t._path)?aa(e.infoSyncTree_,t,n):aa(e.serverSyncTree_,t,n),Ka(e.eventQueue_,t._path,i)}function cc(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function lc(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Wi(n,...t)}function hc(e,t,n,i){t&&ir((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}function uc(e,t,n){return la(e.serverSyncTree_,t,n)||ps.EMPTY_NODE}function dc(e,t=e.transactionQueueTree_){if(t||_c(e,t),Ra(t)){const n=mc(e,t);h(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=uc(e,t,i);let s=r;const o=r.hash();for(let e=0;e<n.length;e++){const i=n[e];h(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=Dr(t,i.path);s=s.updateChild(r,i.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(i=>{lc(e,"transaction put response",{path:c.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(sa(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();_c(e,Na(e.transactionQueueTree_,t)),dc(e,e.transactionQueueTree_),Ga(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)ir(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{$i("transaction at "+c.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}fc(e,t)}}),o)}(e,Da(t),n)}else Aa(t)&&Oa(t,(t=>{dc(e,t)}))}function fc(e,t){const n=pc(e,t),i=Da(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=Dr(n,c.path);let u,d=!1;if(h(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)d=!0,u=c.abortReason,r=r.concat(sa(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)d=!0,u="maxretry",r=r.concat(sa(e.serverSyncTree_,c.currentWriteId,!0));else{const n=uc(e,c.path,s);c.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Wa("transaction failed: Data returned ",i,c.path);let t=gs(i);"object"==typeof i&&null!=i&&L(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=tc(e),l=ka(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=sc(e),s.splice(s.indexOf(o),1),r=r.concat(ra(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),r=r.concat(sa(e.serverSyncTree_,o,!0))}else d=!0,u="nodata",r=r.concat(sa(e.serverSyncTree_,c.currentWriteId,!0))}Ga(e.eventQueue_,n,r),r=[],d&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;_c(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)ir(i[e]);dc(e,e.transactionQueueTree_)}(e,mc(e,n),i),i}function pc(e,t){let n,i=e.transactionQueueTree_;for(n=xr(t);null!==n&&void 0===Ra(i);)i=Na(i,n),n=xr(t=Nr(t));return i}function mc(e,t){const n=[];return gc(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function gc(e,t,n){const i=Ra(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);Oa(t,(t=>{gc(e,t,n)}))}function _c(e,t){const n=Ra(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Pa(t,n.length>0?n:void 0)}Oa(t,(t=>{_c(e,t)}))}function yc(e,t){const n=Da(pc(e,t)),i=Na(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{vc(e,t)})),vc(e,i),La(i,(t=>{vc(e,t)})),n}function vc(e,t){const n=Ra(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(h(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(h(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(sa(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Pa(t,void 0):n.length=s+1,Ga(e.eventQueue_,Da(t),r);for(let e=0;e<i.length;e++)ir(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Tc{get key(){return Lr(this._path)?null:Rr(this._path)}get ref(){return new kc(this._repo,this._path)}get _queryIdentifier(){const e=Rs(this._queryParams),t=Qi(e);return"{}"===t?"default":t}get _queryObject(){return Rs(this._queryParams)}isEqual(e){if(!((e=J(e))instanceof Tc))return!1;const t=this._repo===e._repo,n=Mr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class kc extends Tc{get parent(){const e=Ar(this._path);return null===e?null:new kc(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new Ss,!1)}}class xc{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Tr(e),n=Nc(this.ref,e);return new xc(this._node.getChild(t),n,os)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new xc(n,Nc(this.ref,t),os))))}hasChild(e){const t=new Tr(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Sc(e,t){return(e=J(e))._checkNotDeleted("ref"),void 0!==t?Nc(e._root,t):e._root}function Nc(e,t){var n,i,r,s;return null===xr((e=J(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),za(n,i,r,s)):za("child","path",t,!1),new kc(e._repo,Or(e._path,t))}function Rc(e,t){e=J(e),Ha("push",e._path),ja("push",t,e._path,!0);const n=ec(e._repo),i=ws(n),r=Nc(e,i),s=Nc(e,i);let o;return o=null!=t?Pc(s,t).then((()=>s)):Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function Pc(e,t){e=J(e),Ha("set",e._path),ja("set",t,e._path,!1);const n=new v;return oc(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}class Ac{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Cc("value",this,new xc(e.snapshotNode,new kc(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Ic(this,e,t):null}matches(e){return e instanceof Ac&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}class Oc{respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Ic(this,e,t):null}createEvent(e,t){h(null!=e.childName,"Child events should have a childName.");const n=Nc(new kc(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Cc(e.type,this,new xc(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Oc&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}constructor(e,t){this.eventType=e,this.callbackContext=t}}function Lc(e,t,n,i,r){let s;if("object"==typeof i&&(s=void 0,r=i),"function"==typeof i&&(s=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{ac(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Ec(n,s||void 0),a="value"===t?new Ac(o):new Oc(t,o);return function(e,t,n){let i;i=".info"===xr(t._path)?ca(e.infoSyncTree_,t,n):ca(e.serverSyncTree_,t,n),Ka(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>ac(e._repo,e,a)}function Dc(e,t,n,i){return Lc(e,"value",t,n,i)}!function(e){h(!zo,"__referenceConstructor has already been defined"),zo=e}(kc),function(e){h(!Ho,"__referenceConstructor has already been defined"),Ho=e}(kc);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Mc={};let Uc=!1;function Fc(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Vi("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Wi("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=wc(s,r),l=c.repoInfo;void 0!==Si&&Si.env&&(a=Si.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=wc(s,r),l=c.repoInfo):o=!c.repoInfo.secure;const h=r&&o?new ar(ar.OWNER):new or(e.name,e.options,t);Va("Invalid Firebase Database URL",c),Lr(c.path)||Vi("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=Mc[t.name];r||(r={},Mc[t.name]=r);let s=r[e.toURLString()];s&&Vi("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new Xa(e,Uc,n,i),r[e.toURLString()]=s,s}(l,e,h,new sr(e.name,n));return new qc(u,e)}class qc{get _repo(){return this._instanceStarted||(Za(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new kc(this._repo,kr())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Mc[t];n&&n[e.key]===e||Vi(`Database ${t}(${e.repoInfo_}) has already been deleted.`),cc(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Vi("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}Wr.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Wr.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ni="9.8.3",Pe(new Q("database",((e,{instanceIdentifier:t})=>Fc(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Me("@firebase/database","0.13.1",e),Me("@firebase/database","0.13.1","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=De()){const t=Ae(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ae(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(F(n.getOptions(),null!=t?t:{}))return e;Xe(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Ti,persistence:[jn,xn,Nn]})}(zc),$c=new class{async fetchTrendingMovies(e){try{const t=await n(o)(`/trending/movie/day?api_key=dad2725b968ab7e952dfbc80999b3d08&page=${e}`);console.log(t.data);const{results:i,total_pages:r}=t.data;return{results:i,total_pages:r}}catch(e){console.log(e.message)}}async fetchMoviesByKeyWord(e){try{const t=await n(o)(`/search/movie?&api_key=dad2725b968ab7e952dfbc80999b3d08&query=${this.searchQuery}&page=${e}`);console.log(t.data);const{results:i,total_pages:r}=t.data;return{results:i,total_pages:r}}catch(e){console.log(e.message)}}async fetchMovieInfo(e){try{const t=await n(o)(`movie/${e}?api_key=dad2725b968ab7e952dfbc80999b3d08`);return console.log("это",t.data),t.data}catch(e){console.log(e.message)}}getPage(){return this.page}incrementPage(){this.page+=1}resetPage(){this.page=1}get query(){return this.searchQuery}set query(e){this.searchQuery=e}constructor(){this.searchQuery=""}},Yc=document.querySelector(".grid"),Kc=document.querySelector(".home-grid"),Gc=document.querySelector(".search-form"),Jc=document.querySelector(".form-wrap"),Qc=document.querySelector(".header__failure-message"),Xc=document.querySelector(".gallery__failure-message"),Zc=document.querySelector(".nav__btn--home"),el=document.querySelector(".nav__btn--library"),tl=document.querySelector(".header"),nl=document.querySelector(".buttons"),il=document.querySelector(".movie-card"),rl=document.querySelector("[data-modal]"),sl=document.querySelector("[data-modal-close]"),ol=document.querySelector("[data-auth-close]"),al=document.getElementById("next-page"),cl=document.getElementById("prev-page"),ll=document.querySelector(".pagination__page-buttons"),hl=document.querySelector("[data-auth]"),ul=document.querySelector(".auth__wrap"),dl=document.getElementById("txtEmail"),fl=document.getElementById("txtPassword"),pl=document.getElementById("btnLogin"),ml=document.getElementById("btnSignup"),gl=document.getElementById("btnLogout"),_l=document.querySelector(".auth__success-msg"),yl=document.querySelector(".auth__logout"),vl=document.querySelector(".btn-watched"),wl=document.querySelector(".btn-queue"),bl=[{id:12,name:"Adventure"},{id:14,name:"Fantasy"},{id:16,name:"Animation"},{id:18,name:"Drama"},{id:27,name:"Horror"},{id:28,name:"Action"},{id:35,name:"Comedy"},{id:36,name:"History"},{id:37,name:"Western"},{id:53,name:"Thriller"},{id:80,name:"Crime"},{id:99,name:"Documentary"},{id:878,name:"Science Fiction"},{id:9648,name:"Mystery"},{id:10402,name:"Music"},{id:10749,name:"Romance"},{id:10751,name:"Family"},{id:10752,name:"War"},{id:10770,name:"TV Movie"}];Gc.addEventListener("submit",(async function(e){e.preventDefault(),$c.query=e.currentTarget.elements.searchQuery.value,Xc.textContent="",Qc.textContent="",""===$c.query&&(Xc.textContent="Oops, something went wrong!");try{const{results:e,total_pages:t}=await $c.fetchMoviesByKeyWord(1);0===e.length&&(Qc.textContent="Search result not successful. Enter the correct movie name and"),El=t,ll.innerHTML="",Kc.innerHTML="",Al(e,Kc),Sl(1,5),Tl=!0}catch(e){console.log(e)}})),Zc.addEventListener("click",(function(){Kc.innerHTML="",ll.innerHTML="",Pl(),tl.classList.replace("library-header","header"),Zc.parentElement.classList.add("nav__item--active"),el.parentNode.classList.remove("nav__item--active"),nl.classList.add("hidden"),Jc.classList.remove("hidden"),Yc.classList.add("home-grid"),Yc.classList.remove("library-grid")})),el.addEventListener("click",(function(){ll.innerHTML="",Kc.innerHTML="",tl.classList.replace("header","library-header"),el.parentNode.classList.add("nav__item--active"),Zc.parentNode.classList.remove("nav__item--active"),Jc.classList.add("hidden"),nl.classList.remove("hidden"),Yc.classList.remove("home-grid"),Yc.classList.add("library-grid"),al.classList.add("hidden"),cl.classList.add("hidden")})),pl.addEventListener("click",(async function(){const e=dl.value,t=fl.value;try{const s=await(n=Vc,i=e,r=t,In(J(n),cn.credential(i,r)));_l.textContent=`You've signed in with email ${s.user.email}`}catch(e){Wc.Notify.failure(`${e.message}`)}var n,i,r;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),ml.addEventListener("click",(async function(){const e=dl.value,t=fl.value;try{const n=await En(Vc,e,t);_l.textContent=`You've created account with email ${n.user.email}`}catch(e){Wc.Notify.failure(`${e.message}`)}})),gl.addEventListener("click",(async function(){await(e=Vc,J(e).signOut());var e})),vl.addEventListener("click",Ul),wl.addEventListener("click",Ul),al.addEventListener("click",(function(){if(Number(Cl.textContent)%5==0){const e=Number(Cl.textContent)+1;return ll.innerHTML="",Sl(e,5),void(!1===Tl?Nl(e):Rl(e))}Cl=Cl.nextElementSibling,Cl.classList.add("pagination__activ"),Cl.previousElementSibling.classList.remove("pagination__activ");const e=Cl.textContent;!1===Tl?Nl(e):Rl(e),Number(Cl.textContent)===El?al.disabled=!0:1===Number(Cl.textContent)?cl.disabled=!0:cl.disabled=!1})),cl.addEventListener("click",(function(){if((Number(Cl.textContent)-1)%5==0){const e=Number(Cl.textContent)-1;ll.innerHTML="";return Sl(e-5+1,5),!1===Tl?Nl(e):Rl(e),Cl=ll.lastElementChild,ll.firstElementChild.classList.remove("pagination__activ"),void Cl.classList.add("pagination__activ")}Cl.classList.remove("pagination__activ"),Cl=Cl.previousElementSibling,Cl.classList.add("pagination__activ");const e=Cl.textContent;!1===Tl?Nl(e):Rl(e),1===Number(Cl.textContent)?cl.disabled=!0:cl.disabled=!1})),ll.addEventListener("click",(function(e){if(Cl.classList.remove("pagination__activ"),"BUTTON"!==e.target.nodeName)return;Cl=e.target,Cl.classList.add("pagination__activ");const t=Cl.textContent;!1===Tl?Nl(t):Rl(t),1===Number(Cl.textContent)?cl.disabled=!0:cl.disabled=!1})),Zc.parentElement.classList.add("nav__item--active"),nl.classList.add("hidden"),Yc.classList.add("home-grid"),Pl(),Yc.addEventListener("click",(async function(e){if("IMG"!==e.target.nodeName)return;const t=e.target.id,n=await $c.fetchMovieInfo(t);rl.classList.remove("is-hidden"),function(e){il.innerHTML="";const t=function(e){const t=e.genres.map((e=>e.name)).join(", "),n=Number(e.popularity).toFixed(1).toString();return`\n      <img class="movie-card__poster" src="https://image.tmdb.org/t/p/w500${e.poster_path}" id = "${e.id}" alt="${e.title}"/>\n      <div class="film-card__info">\n            <h2 class="film-card__title">${e.title}</h2>\n            <div class="film-card__details">\n                  <p>\n                        <span class="film-card__detail">Vote / Votes</span>\n                        <b class = "film-card__value"><span class="film-card__value--accent">${e.vote_average}</span>/${e.vote_count}</b>\n                   </p>\n                  <p>\n                        <span class="film-card__detail">Popularity</span>\n                        <b class = "film-card__value">${n}</b>\n                  </p>\n                  <p>\n                      <span class="film-card__detail">Original Title</span>\n                      <b class = "film-card__value film-card__value--upper">${e.original_title}</b>\n                  </p>\n                  <p>\n                      <span class="film-card__detail">Genre</span>\n                      <b class = "film-card__value">${t}</b>\n                  </p>\n            </div>\n            <h3 class="film-card__about">About</h3>\n            <p class="film-card__description">${e.overview}</p>\n            <ul class="modal__option-buttons">\n                  <button type="button" class="btn-modal" id="addWatched">add to Watched</button>\n                  <button type="button" class="btn-modal" id="addQueue">add to queue</button>\n            </ul>\n      </div>`}(e);il.insertAdjacentHTML("beforeend",t);const n=document.getElementById("addWatched"),i=document.getElementById("addQueue");Ol=e.id,Ll=e,n.addEventListener("click",Dl),i.addEventListener("click",Dl)}(n)})),sl.addEventListener("click",(function(){rl.classList.toggle("is-hidden")})),ol.addEventListener("click",(function(){hl.classList.toggle("is-hidden")}));let Cl=null,Il=[],El=0;let Tl=!1,kl=null;async function xl(){var e,t,n;e=e=>{e?(_l.textContent=`You've entered with email ${e.email}`,ul.classList.add("hidden"),yl.classList.remove("hidden"),ol.classList.remove("hidden"),kl=e.uid,console.log(kl)):(ul.classList.remove("hidden"),yl.classList.add("hidden"),ol.classList.add("hidden"))},J(Vc).onAuthStateChanged(e,t,n)}function Sl(e,t){const n=function(e,t){let n=[];for(let i=e;i<=t;i+=1)n.push(`<button type="button" class="pagination__btn page">${i}</button>`);return n.join("")}(e,e+t-1);ll.insertAdjacentHTML("beforeend",n),Il=document.querySelectorAll(".page"),Cl=Il[0],Cl.classList.add("pagination__activ")}async function Nl(e){Kc.innerHTML="";const{results:t,total_pages:n}=await $c.fetchTrendingMovies(e);Al(t,Kc)}async function Rl(e){Kc.innerHTML="";const{results:t,total_pages:n}=await $c.fetchMoviesByKeyWord(e);Al(t,Kc)}async function Pl(){hl.classList.remove("is-hidden"),ol.classList.add("hidden"),xl();try{const{results:e,total_pages:t}=await $c.fetchTrendingMovies(1);Al(e,Kc),El=t,Sl(1,5),Tl=!1}catch(e){console.log(e)}}function Al(e,t){const n=function(e){return e.map((e=>{let t="";var n;e.genre_ids?(n=e.genre_ids,t=bl.filter((e=>n.includes(e.id))).map((e=>e.name)).join(", ")):t=e.genres.map((e=>e.name)).join(", ");const i=function(e){let t;return t=e?e.slice(0,4):"unknown year",t}(e.release_date);return`\n               <a class="film">\n                  <img class="film__poster" src="https://image.tmdb.org/t/p/w500${e.poster_path}" id = "${e.id}" alt="${e.title}" loading="lazy" />\n                  <div class="film__info">\n                        <p class="film__title">${e.title}</p>\n                        <p class="film__genre">${t}<span> | ${i}</span></p>\n                  </div>\n               </a>`})).join("")}(e);t.insertAdjacentHTML("beforeend",n)}let Ol=null,Ll=null;function Dl(e){"addWatched"===e.currentTarget.id&&Ml(kl,Ll,"/watched"),"addQueue"===e.currentTarget.id&&Ml(kl,Ll,"/queue")}function Ml(e,t,n){Rc(Sc(Hc,"users/"+e+`${n}`),{film:t})}function Ul(e){let t=null;e.currentTarget.classList.contains("btn-watched")&&(t=Sc(Hc,"users/"+kl+"/watched")),e.currentTarget.classList.contains("btn-queue")&&(t=Sc(Hc,"users/"+kl+"/queue")),Dc(t,(e=>{const t=e.val(),n=Object.values(t).map((e=>e.film)),i=document.querySelector(".library-grid");i.innerHTML="",Al(n,i)}))}
//# sourceMappingURL=index.337b9652.js.map
