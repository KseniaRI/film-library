 ...
 * limitations under the License.
 */
function w(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function b(){return"undefined"!=typeof window&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(w())}function I(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function E(){return"object"==typeof navigator&&"ReactNative"===navigator.product}function C(){const e=w();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function T(){return!0===a||!0===l}class k extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,k.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,S.prototype.create)}}class S{create(e,...t){const n=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],s=r?function(e,t){return e.replace(x,((e,n)=>{const i=t[n];return null!=i?String(i):`<${n}?>`}))}(r,n):"Error",o=`${this.serviceName}: ${s} (${i}).`;return new k(i,o,n)}constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}}const x=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ve;Ve="",Pe(new Q("platform-logger",(e=>new Te(e)),"PRIVATE")),Pe(new Q("heartbeat",(e=>new je(e)),"PRIVATE")),Me("@firebase/app","0.7.26",Ve),Me("@firebase/app","0.7.26","esm2017"),Me("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(lt()||I()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ut{get(){return ht()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}constructor(e,t){this.shortDelay=e,this.longDelay=t,rt(t>e,"Short delay should be less than long delay!"),this.isMobile=b()||E()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(e){return 1e3*Number(e)}function Tt(e){const[t,n,i]=e.split(".");if(void 0===t||void 0===n||void 0===i)return Qe("JWT malformed, contained fewer than 3 sections"),null;try{const e=g(n);return e?JSON.parse(e):(Qe("Failed to decode base64 JWT payload"),null)}catch(e){return Qe("Caught error parsing JWT payload as JSON",e),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nt(e){var t;const n=e.auth,i=await e.getIdToken(),r=await kt(e,async function(e,t){return _t(e,"POST","/v1/accounts:lookup",t)}(n,{idToken:i}));nt(null==r?void 0:r.users.length,n,"internal-error");const s=r.users[0];e._notifyReloadListener(s);const o=(null===(t=s.providerUserInfo)||void 0===t?void 0:t.length)?s.providerUserInfo.map((e=>{var{providerId:t}=e,n=$e(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})):[];const a=(l=e.providerData,c=o,[...l.filter((e=>!c.some((t=>t.providerId===e.providerId)))),...c]);var l,c;const h=e.isAnonymous,u=!(e.email&&s.passwordHash||(null==a?void 0:a.length)),d=!!h&&u,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new xt(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(e,f)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Rt{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){nt(e.idToken,"internal-error"),nt(void 0!==e.idToken,"internal-error"),nt(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=Tt(e);return nt(t,"internal-error"),nt(void 0!==t.exp,"internal-error"),nt(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return nt(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(jt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ft(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ht(t))return"Blackberry";if(zt(t))return"Webos";if(qt(t))return"Safari";if((t.includes("chrome/")||Bt(t))&&!t.includes("edge/"))return"Chrome";if(Wt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ft(e=w()){return/firefox\//i.test(e)}function qt(e=w()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Bt(e=w()){return/crios\//i.test(e)}function jt(e=w()){return/iemobile/i.test(e)}function Wt(e=w()){return/android/i.test(e)}function Ht(e=w()){return/blackberry/i.test(e)}function zt(e=w()){return/webos/i.test(e)}function Vt(e=w()){return/iphone|ipad|ipod/i.test(e)}function $t(){return C()&&10===document.documentMode}function Yt(e=w()){return Vt(e)||Wt(e)||zt(e)||Ht(e)||/windows phone/i.test(e)||jt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an{static parseLink(e){const t=function(e){const t=j(W(e)).link,n=t?j(W(t)).deep_link_id:null,i=j(W(e)).deep_link_id;return(i?j(W(i)).link:null)||i||n||t||e}(e);try{return new an(t)}catch(e){return null}}constructor(e){var t,n,i,r,s,o;const a=j(W(e)),l=null!==(t=a.apiKey)&&void 0!==t?t:null,c=null!==(n=a.oobCode)&&void 0!==n?n:null,h=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);nt(l&&c&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=c,this.continueUrl=null!==(r=a.continueUrl)&&void 0!==r?r:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn extends cn{addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}constructor(){super(...arguments),this.scopes=[]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn extends Tn{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}xn.type="SESSION";const Nn=xn;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,s;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=Ze("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(s=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==s?s:document).appendChild(i)}))}function Hn(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Hn("rcb"),new ut(3e4,6e4);async function zn(e,t,n){var i;const r=await n.verify();try{let s;if(nt("string"==typeof r,e,"argument-error"),nt("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){nt("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qn{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Gn;case"linkViaPopup":case"linkViaRedirect":return Jn;case"reauthViaPopup":case"reauthViaRedirect":return Kn;default:Xe(this.auth,"internal-error")}}resolve(e){rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fi=new ut(3e4,6e4);function pi(){const e=On().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let mi=null;function gi(e){return mi=mi||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){pi(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{pi(),n(Ze(e,"network-request-failed"))},timeout:fi.get()})}if(null===(r=null===(i=On().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=On().gapi)||void 0===s?void 0:s.load)){const t=Hn("iframefcb");return On()[t]=()=>{gapi.load?o():n(Ze(e,"network-request-failed"))},Wn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw mi=null,e}))}(e),mi}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const bi={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};class Ii{close(){if(this.window)try{this.window.close()}catch(e){}}constructor(e){this.window=e,this.associatedEvent=null}}function Ei(e,t,n,i=500,r=600){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const l=Object.assign(Object.assign({},bi),{width:i.toString(),height:r.toString(),top:s,left:o}),c=w().toLowerCase();n&&(a=Bt(c)?"_blank":n),Ft(c)&&(t=t||"http://localhost",l.scrollbars="yes");const h=Object.entries(l).reduce(((e,[t,n])=>`${e}${t}=${n},`),"");if(function(e=w()){var t;return Vt(e)&&!!(null===(t=window.navigator)||void 0===t?void 0:t.standalone)}(c)&&"_self"!==a)return function(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr extends Er{static getInstance(){return new Cr}getInitialEvent(e){return h("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||b()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}}function kr(){return new Tr("")}function Sr(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function xr(e){return e.pieces_.length-e.pieceNum_}function Nr(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new Tr(e.pieces_,t)}function Rr(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function Pr(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Ar(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new Tr(t,0)}function Or(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof Tr)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new Tr(n,0)}function Lr(e){return e.pieceNum_>=e.pieces_.length}function Dr(e,t){const n=Sr(e),i=Sr(t);if(null===n)return t;if(n===i)return Dr(Nr(e),Nr(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function Mr(e,t){if(xr(e)!==xr(t))return!1;for(let n=e.pieceNum_,i=t.pieceNum_;n<=e.pieces_.length;n++,i++)if(e.pieces_[n]!==t.pieces_[i])return!1;return!0}function Ur(e,t){let n=e.pieceNum_,i=t.pieceNum_;if(xr(e)>xr(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[i])return!1;++n,++i}return!0}class Fr{constructor(e,t){this.errorPrefix_=t,this.parts_=Pr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=K(this.parts_[e]);qr(this)}}function qr(e){if(e.byteLength_>768)throw new Error(e.errorPrefix_+"has a key path longer than 768 bytes ("+e.byteLength_+").");if(e.parts_.length>32)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written (32) or object contains a cycle "+Br(e))}function Br(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new Hr("[MIN_NAME]",e),i=new Hr("[MIN_NAME]",t);return 0!==this.compare(n,i)}minPost(){return Hr.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vr;class $r extends zr{static get __EMPTY_NODE(){return Vr}static set __EMPTY_NODE(e){Vr=e}compare(e,t){return Gi(e.name,t.name)}isDefinedOn(e){throw u("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Hr.MIN}maxPost(){return new Hr("[MAX_NAME]",Vr)}makePost(e,t){return h("string"==typeof e,"KeyIndex indexValue must always be a string."),new Hr(e,Vr)}toString(){return".key"}}const Yr=new $r;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/as,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}}const cs=function(e,t,n,i){e.sort(t);const r=function(t,i){const s=i-t;let o,a;if(0===s)return null;if(1===s)return o=e[t],a=n?n(o):o,new Kr(a,o.node,Kr.BLACK,null,null);{const l=parseInt(s/2,10)+t,c=r(t,l),h=r(l+1,i);return o=e[l],a=n?n(o):o,new Kr(a,o.node,Kr.BLACK,c,h)}},s=function(t){let i=null,s=null,o=e.length;const a=function(t,i){const s=o-t,a=o;o-=t;const c=r(s+1,a),h=e[s],u=n?n(h):h;l(new Kr(u,h.node,i,null,c))},l=function(e){i?(i.left=e,i=e):(s=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,Kr.BLACK):(a(i,Kr.BLACK),a(i,Kr.RED))}return s}(new ls(e.length));return new Jr(i||t,s)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hs;const us={};class ds{static get Default(){return h(us&&os,"ChildrenNode.ts has not been loaded"),hs=hs||new ds({".priority":us},{".priority":os}),hs}get(e){const t=D(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Jr?t:null}hasIndex(e){return L(this.indexSet_,e.toString())}addIndex(e,t){h(e!==Yr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const r=t.getIterator(Hr.Wrap);let s,o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=r.getNext();s=i?cs(n,e.getCompare()):us;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=s,new ds(c,l)}addToIndexes(e,t){const n=U(this.indexes_,((n,i)=>{const r=D(this.indexSet_,i);if(h(r,"Missing index implementation for "+i),n===us){if(r.isDefinedOn(e.node)){const n=[],i=t.getIterator(Hr.Wrap);let s=i.getNext();for(;s;)s.name!==e.name&&n.push(s),s=i.getNext();return n.push(e),cs(n,r.getCompare())}return us}{const i=t.get(e.name);let r=n;return i&&(r=r.remove(new Hr(e.name,i))),r.insert(e,e.node)}}));return new ds(n,this.indexSet_)}removeFromIndexes(e,t){const n=U(this.indexes_,(n=>{if(n===us)return n;{const i=t.get(e.name);return i?n.remove(new Hr(e.name,i)):n}}));return new ds(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class _s extends zr{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?Gi(e.name,t.name):r}makePost(e,t){const n=gs(e),i=ps.EMPTY_NODE.updateChild(this.indexPath_,n);return new Hr(t,i)}maxPost(){const e=ps.EMPTY_NODE.updateChild(this.indexPath_,ms);return new Hr("[MAX_NAME]",e)}toString(){return Pr(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,h(!Lr(e)&&".priority"!==Sr(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ys=new class extends zr{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Gi(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Hr.MIN}maxPost(){return Hr.MAX}makePost(e,t){const n=gs(e);return new Hr(t,n)}toString(){return".value"}},vs="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",ws=function(){let e=0;const t=[];return function(n){const i=n===e;let r;e=n;const s=new Array(8);for(r=7;r>=0;r--)s[r]=vs.charAt(n%64),n=Math.floor(n/64);h(0===n,"Cannot push at time == 0");let o=s.join("");if(i){for(r=11;r>=0&&63===t[r];r--)t[r]=0;t[r]++}else for(r=0;r<12;r++)t[r]=Math.floor(64*Math.random());for(r=0;r<12;r++)o+=vs.charAt(t[r]);return h(20===o.length,"nextPushId: Length should be 20."),o}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ts{updateChild(e,t,n,i,r,s){h(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(i).equals(n.getChild(i))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(Es(t,o)):h(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(Is(t,n)):s.trackChildChange(Cs(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(os,((e,i)=>{t.hasChild(e)||n.trackChildChange(Es(e,i))})),t.isLeafNode()||t.forEachChild(os,((t,i)=>{if(e.hasChild(t)){const r=e.getImmediateChild(t);r.equals(i)||n.trackChildChange(Cs(t,i,r))}else n.trackChildChange(Is(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?ps.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){return this.index_.compare(this.getStartPost(),e)<=0&&this.index_.compare(e,this.getEndPost())<=0}updateChild(e,t,n,i,r,s){return this.matches(new Hr(t,n))||(n=ps.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,i,r,s)}updateFullNode(e,t,n){t.isLeafNode()&&(t=ps.EMPTY_NODE);let i=t.withIndex(this.index_);i=i.updatePriority(ps.EMPTY_NODE);const r=this;return t.forEachChild(os,((e,t)=>{r.matches(new Hr(e,t))||(i=i.updateImmediateChild(e,ps.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,i,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}constructor(e){this.indexedFilter_=new Ts(e.getIndex()),this.index_=e.getIndex(),this.startPost_=ks.getStartPost_(e),this.endPost_=ks.getEndPost_(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{updateChild(e,t,n,i,r,s){return this.rangedFilter_.matches(new Hr(t,n))||(n=ps.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,i,r,s):this.fullLimitUpdateChild_(e,t,n,r,s)}updateFullNode(e,t,n){let i;if(t.isLeafNode()||t.isEmpty())i=ps.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;i=ps.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();let r;if(r=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),t)<=0:this.index_.compare(t,this.rangedFilter_.getEndPost())<=0,!r)break;i=i.updateImmediateChild(t.name,t.node),n++}}else{let e,n,r,s;if(i=t.withIndex(this.index_),i=i.updatePriority(ps.EMPTY_NODE),this.reverse_){s=i.getReverseIterator(this.index_),e=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const t=this.index_.getCompare();r=(e,n)=>t(n,e)}else s=i.getIterator(this.index_),e=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),r=this.index_.getCompare();let o=0,a=!1;for(;s.hasNext();){const t=s.getNext();!a&&r(e,t)<=0&&(a=!0);a&&o<this.limit_&&r(t,n)<=0?o++:i=i.updateImmediateChild(t.name,ps.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,i,r){let s;if(this.reverse_){const e=this.index_.getCompare();s=(t,n)=>e(n,t)}else s=this.index_.getCompare();const o=e;h(o.numChildren()===this.limit_,"");const a=new Hr(t,n),l=this.reverse_?o.getFirstChild(this.index_):o.getLastChild(this.index_),c=this.rangedFilter_.matches(a);if(o.hasChild(t)){const e=o.getImmediateChild(t);let h=i.getChildAfterChild(this.index_,l,this.reverse_);for(;null!=h&&(h.name===t||o.hasChild(h.name));)h=i.getChildAfterChild(this.index_,h,this.reverse_);const u=null==h?1:s(h,a);if(c&&!n.isEmpty()&&u>=0)return null!=r&&r.trackChildChange(Cs(t,n,e)),o.updateImmediateChild(t,n);{null!=r&&r.trackChildChange(Es(t,e));const n=o.updateImmediateChild(t,ps.EMPTY_NODE);return null!=h&&this.rangedFilter_.matches(h)?(null!=r&&r.trackChildChange(Is(h.name,h.node)),n.updateImmediateChild(h.name,h.node)):n}}return n.isEmpty()?e:c&&s(l,a)>=0?(null!=r&&(r.trackChildChange(Es(l.name,l.node)),r.trackChildChange(Is(t,n))),o.updateImmediateChild(t,n).updateImmediateChild(l.name,ps.EMPTY_NODE)):e}constructor(e){this.rangedFilter_=new ks(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Ds(i,new Tr(t.toString()+"/"+e),n)}))}class Ms{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Zi(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{operationForChild(e){return Lr(this.path)?new Hs(this.source,kr(),this.snap.getImmediateChild(e)):new Hs(this.source,Nr(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Fs.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{operationForChild(e){if(Lr(this.path)){const t=this.children.subtree(new Tr(e));return t.isEmpty()?null:t.value?new Hs(this.source,kr(),t.value):new zs(this.source,kr(),t)}return h(Sr(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zs(this.source,Nr(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fs.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);r.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function Gs(e,t){return{eventCache:e,serverCache:t}}function Ks(e,t,n,i){return Gs(new Vs(t,n,i),e.serverCache)}function Js(e,t,n,i){return Gs(e.eventCache,new Vs(t,n,i))}function Qs(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Xs(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class So{trackChildChange(e){const t=e.type,n=e.childName;h("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),h(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,Cs(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,Es(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,Is(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw u("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Cs(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class No{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Vs(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Co(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Xs(this.viewCache_),r=Eo(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ro(e,t,n,i,r){const s=new So;let o,a;if(n.type===Fs.OVERWRITE){const l=n;l.source.fromUser?o=Oo(e,t,l.path,l.snap,i,r,s):(h(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Lr(l.path),o=Ao(e,t,l.path,l.snap,i,r,a,s))}else if(n.type===Fs.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,l)=>{const c=Or(n,i);Lo(t,Sr(c))&&(a=Oo(e,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=Or(n,i);Lo(t,Sr(c))||(a=Oo(e,a,c,l,r,s,o))})),a}(e,t,l.path,l.children,i,r,s):(h(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Mo(e,t,l.path,l.children,i,r,a,s))}else if(n.type===Fs.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=Io(i,n))return t;{const a=new No(i,t,r),l=t.eventCache.getNode();let c;if(Lr(n)||".priority"===Sr(n)){let n;if(t.serverCache.isFullyInitialized())n=vo(i,Xs(t));else{const e=t.serverCache.getNode();h(e instanceof ps,"serverChildren would be complete if leaf node"),n=wo(i,e)}c=e.filter.updateFullNode(l,n,s)}else{const r=Sr(n);let h=Co(i,r,t.serverCache);null==h&&t.serverCache.isCompleteForChild(r)&&(h=l.getImmediateChild(r)),c=null!=h?e.filter.updateChild(l,r,h,Nr(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(l,r,ps.EMPTY_NODE,Nr(n),a,s):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=vo(i,Xs(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Io(i,kr()),Ks(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,i,r,s):function(e,t,n,i,r,s,o){if(null!=Io(r,n))return t;const a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=i.value){if(Lr(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Ao(e,t,n,l.getNode().getChild(n),r,s,a,o);if(Lr(n)){let i=new eo(null);return l.getNode().forEachChild(Yr,((e,t)=>{i=i.set(new Tr(e),t)})),Mo(e,t,n,i,r,s,a,o)}return t}{let c=new eo(null);return i.foreach(((e,t)=>{const i=Or(n,e);l.isCompleteForPath(i)&&(c=c.set(e,l.getNode().getChild(i)))})),Mo(e,t,n,c,r,s,a,o)}}(e,t,a.path,a.affectedTree,i,r,s)}else{if(n.type!==Fs.LISTEN_COMPLETE)throw u("Unknown operation type: "+n.type);o=function(e,t,n,i,r){const s=t.serverCache,o=Js(t,s.getNode(),s.isFullyInitialized()||Lr(n),s.isFiltered());return Po(e,o,n,i,xo,r)}(e,t,n.path,i,s)}const l=s.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=Qs(e);(n.length>0||!e.eventCache.isFullyInitialized()||r&&!i.getNode().equals(s)||!i.getNode().getPriority().equals(s.getPriority()))&&n.push(bs(Qs(t)))}}(t,o,l),{viewCache:o,changes:l}}function Po(e,t,n,i,r,s){const o=t.eventCache;if(null!=Io(i,n))return t;{let a,l;if(Lr(n))if(h(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Xs(t),r=wo(i,n instanceof ps?n:ps.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),r,s)}else{const n=vo(i,Xs(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const c=Sr(n);if(".priority"===c){h(1===xr(n),"Can't have a priority with additional path components");const r=o.getNode();l=t.serverCache.getNode();const s=bo(i,n,r,l);a=null!=s?e.filter.updatePriority(r,s):o.getNode()}else{const h=Nr(n);let u;if(o.isCompleteForChild(c)){l=t.serverCache.getNode();const e=bo(i,n,o.getNode(),l);u=null!=e?o.getNode().getImmediateChild(c).updateChild(h,e):o.getNode().getImmediateChild(c)}else u=Co(i,c,t.serverCache);a=null!=u?e.filter.updateChild(o.getNode(),c,u,h,r,s):o.getNode()}}return Ks(t,a,o.isFullyInitialized()||Lr(n),e.filter.filtersNodes())}}function Ao(e,t,n,i,r,s,o,a){const l=t.serverCache;let c;const h=o?e.filter:e.filter.getIndexedFilter();if(Lr(n))c=h.updateFullNode(l.getNode(),i,null);else if(h.filtersNodes()&&!l.isFiltered()){const e=l.getNode().updateChild(n,i);c=h.updateFullNode(l.getNode(),e,null)}else{const e=Sr(n);if(!l.isCompleteForPath(n)&&xr(n)>1)return t;const r=Nr(n),s=l.getNode().getImmediateChild(e).updateChild(r,i);c=".priority"===e?h.updatePriority(l.getNode(),s):h.updateChild(l.getNode(),e,s,r,xo,null)}const u=Js(t,c,l.isFullyInitialized()||Lr(n),h.filtersNodes());return Po(e,u,n,r,new No(r,u,s),a)}function Oo(e,t,n,i,r,s,o){const a=t.eventCache;let l,c;const h=new No(r,t,s);if(Lr(n))c=e.filter.updateFullNode(t.eventCache.getNode(),i,o),l=Ks(t,c,!0,e.filter.filtersNodes());else{const r=Sr(n);if(".priority"===r)c=e.filter.updatePriority(t.eventCache.getNode(),i),l=Ks(t,c,a.isFullyInitialized(),a.isFiltered());else{const s=Nr(n),c=a.getNode().getImmediateChild(r);let u;if(Lr(s))u=i;else{const e=h.getCompleteChild(r);u=null!=e?".priority"===Rr(s)&&e.getChild(Ar(s)).isEmpty()?e:e.updateChild(s,i):ps.EMPTY_NODE}if(c.equals(u))l=t;else{l=Ks(t,e.filter.updateChild(a.getNode(),r,u,s,h,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return l}function Lo(e,t){return e.eventCache.isCompleteForChild(t)}function Do(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Mo(e,t,n,i,r,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let l,c=t;l=Lr(n)?i:new eo(null).setTree(n,i);const h=t.serverCache.getNode();return l.children.inorderTraversal(((n,i)=>{if(h.hasChild(n)){const l=Do(0,t.serverCache.getNode().getImmediateChild(n),i);c=Ao(e,c,new Tr(n),l,r,s,o,a)}})),l.children.inorderTraversal(((n,i)=>{const l=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!h.hasChild(n)&&!l){const l=Do(0,t.serverCache.getNode().getImmediateChild(n),i);c=Ao(e,c,new Tr(n),l,r,s,o,a)}})),c}class Uo{get query(){return this.query_}constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new Ts(n.getIndex()),r=(s=n).loadsAllData()?new Ts(s.getIndex()):s.hasLimit()?new Ss(s):new ks(s);var s;this.processor_=function(e){return{filter:e}}(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(ps.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(ps.EMPTY_NODE,a.getNode(),null),h=new Vs(l,o.isFullyInitialized(),i.filtersNodes()),u=new Vs(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=Gs(u,h),this.eventGenerator_=new $s(this.query_)}}function Fo(e,t){const n=Xs(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Lr(t)&&!n.getImmediateChild(Sr(t)).isEmpty())?n.getChild(t):null}function qo(e){return 0===e.eventRegistrations_.length}function Bo(e,t,n){const i=[];if(n){h(null==t,"A cancel should cancel all event registrations.");const r=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,r);t&&i.push(t)}))}if(t){let n=[];for(let i=0;i<e.eventRegistrations_.length;++i){const r=e.eventRegistrations_[i];if(r.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(i+1));break}}else n.push(r)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return i}function jo(e,t,n,i){t.type===Fs.MERGE&&null!==t.source.queryId&&(h(Xs(e.viewCache_),"We should always have a full cache before handling merges"),h(Qs(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,s=Ro(e.processor_,r,t,n,i);var o,a;return o=e.processor_,a=s.viewCache,h(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),h(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),h(s.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,Wo(e,s.changes,s.viewCache.eventCache.getNode(),null)}function Wo(e,t,n,i){const r=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const r=[],s=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Ys(e,r,"child_removed",t,i,n),Ys(e,r,"child_added",t,i,n),Ys(e,r,"child_moved",s,i,n),Ys(e,r,"child_changed",t,i,n),Ys(e,r,"value",t,i,n),r}(e.eventGenerator_,t,n,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ho,zo;class Vo{constructor(){this.views=new Map}}function $o(e,t,n,i){const r=t.source.queryId;if(null!==r){const s=e.views.get(r);return h(null!=s,"SyncTree gave us an op for an invalid query."),jo(s,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(jo(s,t,n,i));return r}}function Yo(e,t,n,i,r){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=vo(n,r?i:null),s=!1;e?s=!0:i instanceof ps?(e=wo(n,i),s=!1):(e=ps.EMPTY_NODE,s=!1);const o=Gs(new Vs(e,s,!1),new Vs(i,r,!1));return new Uo(t,o)}return o}function Go(e,t,n,i,r,s){const o=Yo(e,t,i,r,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(os,((e,t)=>{i.push(Is(e,t))}));return n.isFullyInitialized()&&i.push(bs(n.getNode())),Wo(e,i,n.getNode(),t)}(o,n)}function Ko(e,t,n,i){const r=t._queryIdentifier,s=[];let o=[];const a=ea(e);if("default"===r)for(const[t,r]of e.views.entries())o=o.concat(Bo(r,n,i)),qo(r)&&(e.views.delete(t),r.query._queryParams.loadsAllData()||s.push(r.query));else{const t=e.views.get(r);t&&(o=o.concat(Bo(t,n,i)),qo(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!ea(e)&&s.push(new(h(Ho,"Reference.ts has not been loaded"),Ho)(t._repo,t._path)),{removed:s,events:o}}function Jo(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Qo(e,t){let n=null;for(const i of e.views.values())n=n||Fo(i,t);return n}function Xo(e,t){if(t._queryParams.loadsAllData())return ta(e);{const n=t._queryIdentifier;return e.views.get(n)}}function Zo(e,t){return null!=Xo(e,t)}function ea(e){return null!=ta(e)}function ta(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let na=1;class ia{constructor(e){this.listenProvider_=e,this.syncPointTree_=new eo(null),this.pendingWriteTree_={visibleWrites:to.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ra(e,t,n,i,r){return function(e,t,n,i,r){h(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=no(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?ua(e,new Hs({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function sa(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(po(e.pendingWriteTree_,t)){let t=new eo(null);return null!=i.snap?t=t.set(kr(),!0):Zi(i.children,(e=>{t=t.set(new Tr(e),!0)})),ua(e,new js(i.path,t,n))}return[]}function oa(e,t,n){return ua(e,new Hs({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function aa(e,t,n,i){const r=t._path,s=e.syncPointTree_.get(r);let o=[];if(s&&("default"===t._queryIdentifier||Zo(s,t))){const a=Ko(s,t,n,i);0===s.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(r));const l=a.removed;o=a.events;const c=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),h=e.syncPointTree_.findOnPath(r,((e,t)=>ea(t)));if(c&&!h){const t=e.syncPointTree_.subtree(r);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&ea(t)){return[ta(t)]}{let e=[];return t&&(e=Jo(t)),Zi(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=pa(e,i);e.listenProvider_.startListening(wa(r),ma(e,r),s.hashFn,s.onComplete)}}}if(!h&&l.length>0&&!i)if(c){const n=null;e.listenProvider_.stopListening(wa(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(ga(t));e.listenProvider_.stopListening(wa(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ga(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return o}function la(e,t,n){const i=t._path;let r=null,s=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Dr(e,i);r=r||Qo(t,n),s=s||ea(t)}));let o,a=e.syncPointTree_.get(i);if(a?(s=s||ea(a),r=r||Qo(a,kr())):(a=new Vo,e.syncPointTree_=e.syncPointTree_.set(i,a)),null!=r)o=!0;else{o=!1,r=ps.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Qo(t,kr());n&&(r=r.updateImmediateChild(e,n))}))}const l=Zo(a,t);if(!l&&!t._queryParams.loadsAllData()){const n=ga(t);h(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=na++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let c=Go(a,t,n,fo(e.pendingWriteTree_,i),r,o);if(!l&&!s){const n=Xo(a,t);c=c.concat(function(e,t,n){const i=t._path,r=ma(e,t),s=pa(e,n),o=e.listenProvider_.startListening(wa(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)h(!ea(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Lr(e)&&t&&ea(t))return[ta(t).query];{let e=[];return t&&(e=e.concat(Jo(t).map((e=>e.query)))),Zi(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(wa(i),ma(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function ca(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Qo(n,Dr(e,t));if(i)return i}));return yo(i,t,r,n,!0)}function ha(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const r=Dr(e,n);i=i||Qo(t,r)}));let r=e.syncPointTree_.get(n);r?i=i||Qo(r,kr()):(r=new Vo,e.syncPointTree_=e.syncPointTree_.set(n,r));const s=null!=i,o=s?new Vs(i,!0,!1):null;return function(e){return Qs(e.viewCache_)}(Yo(r,t,fo(e.pendingWriteTree_,t._path),s?o.getNode():ps.EMPTY_NODE,s))}function ua(e,t){return da(t,e.syncPointTree_,null,fo(e.pendingWriteTree_,kr()))}function da(e,t,n,i){if(Lr(e.path))return fa(e,t,n,i);{const r=t.get(kr());null==n&&null!=r&&(n=Qo(r,kr()));let s=[];const o=Sr(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=To(i,o);s=s.concat(da(a,l,e,t))}return r&&(s=s.concat($o(r,e,i,n))),s}}function fa(e,t,n,i){const r=t.get(kr());null==n&&null!=r&&(n=Qo(r,kr()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=To(i,t),l=e.operationForChild(t);l&&(s=s.concat(fa(l,r,o,a)))})),r&&(s=s.concat($o(r,e,i,n))),s}function pa(e,t){const n=t.query,i=ma(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||ps.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=_a(e,n);if(i){const n=ya(i),r=n.path,s=n.queryId,o=Dr(r,t);return va(e,r,new Ws(Bs(s),o))}return[]}(e,n._path,i):function(e,t){return ua(e,new Ws({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return aa(e,n,null,i)}}}}function ma(e,t){const n=ga(t);return e.queryToTagMap.get(n)}function ga(e){return e._path.toString()+"$"+e._queryIdentifier}function _a(e,t){return e.tagToQueryMap.get(t)}function ya(e){const t=e.indexOf("$");return h(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Tr(e.substr(0,t))}}function va(e,t,n){const i=e.syncPointTree_.get(t);h(i,"Missing sync point for query tag that we're tracking");return $o(i,n,fo(e.pendingWriteTree_,t),null)}function wa(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(h(zo,"Reference.ts has not been loaded"),zo)(e._repo,e._path):e}class ba{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ba(t)}node(){return this.node_}constructor(e){this.node_=e}}class Ia{getImmediateChild(e){const t=Or(this.path_,e);return new Ia(this.syncTree_,t)}node(){return ca(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const Ea=function(e,t,n){return e&&"object"==typeof e?(h(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Ca(e[".sv"],t,n):"object"==typeof e[".sv"]?Ta(e[".sv"],t):void h(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Ca=function(e,t,n){if("timestamp"===e)return n.timestamp;h(!1,"Unexpected server value: "+e)},Ta=function(e,t,n){e.hasOwnProperty("increment")||h(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&h(!1,"Unexpected increment value: "+i);const r=t.node();if(h(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const s=r.getValue();return"number"!=typeof s?i:s+i},ka=function(e,t,n,i){return xa(t,new Ia(n,e),i)},Sa=function(e,t,n){return xa(e,new ba(t),n)};function xa(e,t,n){const i=e.getPriority().val(),r=Ea(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=Ea(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new ss(s,gs(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new ss(r))),i.forEachChild(os,((e,i)=>{const r=xa(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Fa=/[\[\].#$\/\u0000-\u001F\u007F]/,qa=/[\[\].#$\u0000-\u001F\u007F]/,Ba=function(e){return"string"==typeof e&&0!==e.length&&!Fa.test(e)},ja=function(e){return"string"==typeof e&&0!==e.length&&!qa.test(e)},Wa=function(e,t,n,i){i&&void 0===t||Ha(Y(e,"value"),t,n)},Ha=function(e,t,n){const i=n instanceof Tr?new Fr(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Br(i));if("function"==typeof t)throw new Error(e+"contains a function "+Br(i)+" with contents = "+t.toString());if(Yi(t))throw new Error(e+"contains "+t.toString()+" "+Br(i));if("string"==typeof t&&t.length>10485760/3&&K(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Br(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(Zi(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!Ba(t)))throw new Error(e+" contains an invalid key ("+t+") "+Br(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=K(a),qr(o),Ha(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=K(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+Br(i)+" in addition to actual children.")}},za=function(e,t,n,i){if(!(i&&void 0===n||ja(n)))throw new Error(Y(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Va=function(e,t){if(".info"===Sr(t))throw new Error(e+" failed = Can't modify data under /.info/")},$a=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Ba(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),ja(e)}(n))throw new Error(Y(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ya{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ga(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Mr(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Ka(e,t,n){Ga(e,n),Qa(e,(e=>Mr(e,t)))}function Ja(e,t,n){Ga(e,n),Qa(e,(e=>Ur(e,t)||Ur(t,e)))}function Qa(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Xa(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Xa(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qi&&Wi("event: "+n.toString()),ir(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ya,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Os(),this.transactionQueueTree_=new Na,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function el(e,t,n){if(e.stats_=pr(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Ps(e.repoInfo_,((t,n,i,r)=>{il(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>rl(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{R(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Wr(e.repoInfo_,t,((t,n,i,r)=>{il(e,t,n,i,r)}),(t=>{rl(e,t)}),(t=>{!function(e,t){Zi(t,((t,n)=>{sl(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return fr[n]||(fr[n]=t()),fr[n]}(e.repoInfo_,(()=>new Us(e.stats_,e.server_))),e.infoData_=new As,e.infoSyncTree_=new ia({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=oa(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),sl(e,"connected",!1),e.serverSyncTree_=new ia({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);Ja(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function tl(e){const t=e.infoData_.getNode(new Tr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function nl(e){return(t=(t={timestamp:tl(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function il(e,t,n,i,r){e.dataUpdateCount++;const s=new Tr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=U(n,(e=>gs(e)));o=function(e,t,n,i){const r=_a(e,i);if(r){const i=ya(r),s=i.path,o=i.queryId,a=Dr(s,t),l=eo.fromObject(n);return va(e,s,new zs(Bs(o),a,l))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=gs(n);o=function(e,t,n,i){const r=_a(e,i);if(null!=r){const i=ya(r),s=i.path,o=i.queryId,a=Dr(s,t);return va(e,s,new Hs(Bs(o),a,n))}return[]}(e.serverSyncTree_,s,t,r)}else if(i){const t=U(n,(e=>gs(e)));o=function(e,t,n){const i=eo.fromObject(n);return ua(e,new zs({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=gs(n);o=oa(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=pl(e,s)),Ja(e.eventQueue_,a,o)}function rl(e,t){sl(e,"connected",t),!1===t&&function(e){hl(e,"onDisconnectEvents");const t=nl(e),n=Os();Ds(e.onDisconnect_,kr(),((i,r)=>{const s=ka(i,r,e.serverSyncTree_,t);Ls(n,i,s)}));let i=[];Ds(n,kr(),((t,n)=>{i=i.concat(oa(e.serverSyncTree_,t,n));const r=vl(e,t);pl(e,r)})),e.onDisconnect_=Os(),Ja(e.eventQueue_,kr(),i)}(e)}function sl(e,t,n){const i=new Tr("/.info/"+t),r=gs(n);e.infoData_.updateSnapshot(i,r);const s=oa(e.infoSyncTree_,i,r);Ja(e.eventQueue_,i,s)}function ol(e){return e.nextWriteId_++}function al(e,t,n,i,r){hl(e,"set",{path:t.toString(),value:n,priority:i});const s=nl(e),o=gs(n,i),a=ca(e.serverSyncTree_,t),l=Sa(o,a,s),c=ol(e),h=ra(e.serverSyncTree_,t,l,c,!0);Ga(e.eventQueue_,h),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||$i("set at "+t+" failed: "+n);const o=sa(e.serverSyncTree_,c,!s);Ja(e.eventQueue_,t,o),ul(e,r,n,i)}));const u=vl(e,t);pl(e,u),Ja(e.eventQueue_,u,[])}function ll(e,t,n){let i;i=".info"===Sr(t._path)?aa(e.infoSyncTree_,t,n):aa(e.serverSyncTree_,t,n),Ka(e.eventQueue_,t._path,i)}function cl(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function hl(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Wi(n,...t)}function ul(e,t,n,i){t&&ir((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}function dl(e,t,n){return ca(e.serverSyncTree_,t,n)||ps.EMPTY_NODE}function fl(e,t=e.transactionQueueTree_){if(t||yl(e,t),Pa(t)){const n=gl(e,t);h(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=dl(e,t,i);let s=r;const o=r.hash();for(let e=0;e<n.length;e++){const i=n[e];h(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=Dr(t,i.path);s=s.updateChild(r,i.currentOutputSnapshotRaw)}const a=s.val(!0),l=t;e.server_.put(l.toString(),a,(i=>{hl(e,"transaction put response",{path:l.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(sa(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();yl(e,Ra(e.transactionQueueTree_,t)),fl(e,e.transactionQueueTree_),Ja(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)ir(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{$i("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}pl(e,t)}}),o)}(e,Ma(t),n)}else Oa(t)&&La(t,(t=>{fl(e,t)}))}function pl(e,t){const n=ml(e,t),i=Ma(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=Dr(n,l.path);let u,d=!1;if(h(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)d=!0,u=l.abortReason,r=r.concat(sa(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)d=!0,u="maxretry",r=r.concat(sa(e.serverSyncTree_,l.currentWriteId,!0));else{const n=dl(e,l.path,s);l.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Ha("transaction failed: Data returned ",i,l.path);let t=gs(i);"object"==typeof i&&null!=i&&L(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=l.currentWriteId,a=nl(e),c=Sa(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=ol(e),s.splice(s.indexOf(o),1),r=r.concat(ra(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),r=r.concat(sa(e.serverSyncTree_,o,!0))}else d=!0,u="nodata",r=r.concat(sa(e.serverSyncTree_,l.currentWriteId,!0))}Ja(e.eventQueue_,n,r),r=[],d&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;yl(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)ir(i[e]);fl(e,e.transactionQueueTree_)}(e,gl(e,n),i),i}function ml(e,t){let n,i=e.transactionQueueTree_;for(n=Sr(t);null!==n&&void 0===Pa(i);)i=Ra(i,n),n=Sr(t=Nr(t));return i}function gl(e,t){const n=[];return _l(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function _l(e,t,n){const i=Pa(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);La(t,(t=>{_l(e,t,n)}))}function yl(e,t){const n=Pa(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Aa(t,n.length>0?n:void 0)}La(t,(t=>{yl(e,t)}))}function vl(e,t){const n=Ma(ml(e,t)),i=Ra(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{wl(e,t)})),wl(e,i),Da(i,(t=>{wl(e,t)})),n}function wl(e,t){const n=Pa(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(h(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(h(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(sa(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Aa(t,void 0):n.length=s+1,Ja(e.eventQueue_,Ma(t),r);for(let e=0;e<i.length;e++)ir(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tl{onValue(e,t){this.snapshotCallback.call(null,e,t)}onCancel(e){return h(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}get hasCancelCallback(){return!!this.cancelCallback}matches(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}constructor(e,t){this.snapshotCallback=e,this.cancelCallback=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class kl{get key(){return Lr(this._path)?null:Rr(this._path)}get ref(){return new Sl(this._repo,this._path)}get _queryIdentifier(){const e=Rs(this._queryParams),t=Qi(e);return"{}"===t?"default":t}get _queryObject(){return Rs(this._queryParams)}isEqual(e){if(!((e=J(e))instanceof kl))return!1;const t=this._repo===e._repo,n=Mr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class Sl extends kl{get parent(){const e=Ar(this._path);return null===e?null:new Sl(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new xs,!1)}}class xl{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Tr(e),n=Rl(this.ref,e);return new xl(this._node.getChild(t),n,os)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new xl(n,Rl(this.ref,t),os))))}hasChild(e){const t=new Tr(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Nl(e,t){return(e=J(e))._checkNotDeleted("ref"),void 0!==t?Rl(e._root,t):e._root}function Rl(e,t){var n,i,r,s;return null===Sr((e=J(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),za(n,i,r,s)):za("child","path",t,!1),new Sl(e._repo,Or(e._path,t))}function Pl(e,t){e=J(e),Va("push",e._path),Wa("push",t,e._path,!0);const n=tl(e._repo),i=ws(n),r=Rl(e,i),s=Rl(e,i);let o;return o=null!=t?Al(s,t).then((()=>s)):Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function Al(e,t){e=J(e),Va("set",e._path),Wa("set",t,e._path,!1);const n=new v;return al(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Ol(e){return function(e,t){const n=ha(e.serverSyncTree_,t);return null!=n?Promise.resolve(n):e.server_.get(t).then((n=>{const i=gs(n).withIndex(t._queryParams.getIndex()),r=oa(e.serverSyncTree_,t._path,i);return Ka(e.eventQueue_,t._path,r),Promise.resolve(i)}),(n=>(hl(e,"get for query "+R(t)+" failed: "+n),Promise.reject(new Error(n)))))}((e=J(e))._repo,e).then((t=>new xl(t,new Sl(e._repo,e._path),e._queryParams.getIndex())))}class Ll{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new El("value",this,new xl(e.snapshotNode,new Sl(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Cl(this,e,t):null}matches(e){return e instanceof Ll&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}class Dl{respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Cl(this,e,t):null}createEvent(e,t){h(null!=e.childName,"Child events should have a childName.");const n=Rl(new Sl(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new El(e.type,this,new xl(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Dl&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}constructor(e,t){this.eventType=e,this.callbackContext=t}}function Ml(e,t,n,i,r){let s;if("object"==typeof i&&(s=void 0,r=i),"function"==typeof i&&(s=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{ll(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Tl(n,s||void 0),a="value"===t?new Ll(o):new Dl(t,o);return function(e,t,n){let i;i=".info"===Sr(t._path)?la(e.infoSyncTree_,t,n):la(e.serverSyncTree_,t,n),Ka(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>ll(e._repo,e,a)}function Ul(e,t,n,i){return Ml(e,"value",t,n,i)}!function(e){h(!Ho,"__referenceConstructor has already been defined"),Ho=e}(Sl),function(e){h(!zo,"__referenceConstructor has already been defined"),zo=e}(Sl);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Fl={};let ql=!1;function Bl(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Vi("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Wi("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=bl(s,r),c=l.repoInfo;void 0!==xi&&xi.env&&(a=xi.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=bl(s,r),c=l.repoInfo):o=!l.repoInfo.secure;const h=r&&o?new ar(ar.OWNER):new or(e.name,e.options,t);$a("Invalid Firebase Database URL",l),Lr(l.path)||Vi("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=Fl[t.name];r||(r={},Fl[t.name]=r);let s=r[e.toURLString()];s&&Vi("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new Za(e,ql,n,i),r[e.toURLString()]=s,s}(c,e,h,new sr(e.name,n));return new jl(u,e)}class jl{get _repo(){return this._instanceStarted||(el(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Sl(this._repo,kr())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Fl[t];n&&n[e.key]===e||Vi(`Database ${t}(${e.repoInfo_}) has already been deleted.`),cl(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Vi("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}function Wl(e=De(),t){return Ae(e,"database").getImmediate({identifier:t})}Wr.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Wr.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ni="9.8.3",Pe(new Q("database",((e,{instanceIdentifier:t})=>Bl(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Me("@firebase/database","0.13.1",e),Me("@firebase/database","0.13.1","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 */window,Yl&&($l=s("j9NlK"),s("hqFNs"),s("7i1kI"),s("eumNF"),s("5FDPt"),s("58yil"),Yl=$l);const Gl=function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw Oe.create("bad-app-name",{appName:String(i)});const r=xe.get(i);if(r){if(F(e,r.options)&&F(n,r.config))return r;throw Oe.create("duplicate-app",{appName:i})}const s=new Z(i);for(const e of Ne.values())s.addComponent(e);const o=new Le(e,n,s);return xe.set(i,o),o}({apiKey:"AIzaSyBAGTQ42yHhlq8cz77MV0dJG1B6OSt6PVk",authDomain:"filmoteca-db.firebaseapp.com",databaseURL:"https://filmoteca-db-default-rtdb.europe-west1.firebasedatabase.app",projectId:"filmoteca-db",storageBucket:"filmoteca-db.appspot.com",messagingSenderId:"11660297526",appId:"1:11660297526:web:617fc6ad62f4d10da81f97"}),Kl=Wl(Gl),Jl=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=De()){const t=Ae(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ae(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(F(n.getOptions(),null!=t?t:{}))return e;Xe(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Ti,persistence:[jn,Sn,Nn]})}(Gl),Ql=new class{async fetchTrendingMovies(e){try{const t=await n(o)(`/trending/movie/day?api_key=dad2725b968ab7e952dfbc80999b3d08&page=${e}`),{results:i,total_pages:r}=t.data;return{results:i,total_pages:r}}catch(e){console.log(e.message)}}async fetchMoviesByKeyWord(e){try{const t=await n(o)(`/search/movie?&api_key=dad2725b968ab7e952dfbc80999b3d08&query=${this.searchQuery}&page=${e}`),{results:i,total_pages:r}=t.data;return{results:i,total_pages:r}}catch(e){console.log(e.message)}}async fetchMovieInfo(e){try{return(await n(o)(`movie/${e}?api_key=dad2725b968ab7e952dfbc80999b3d08`)).data}catch(e){console.log(e.message)}}get query(){return this.searchQuery}set query(e){this.searchQuery=e}constructor(){this.searchQuery=""}},Xl=document.querySelector(".grid"),Zl=document.querySelector(".home-grid"),ec=document.querySelector(".search-form"),tc=document.querySelector(".form-wrap"),nc=document.querySelector(".header__failure-message"),ic=document.querySelector(".gallery__failure-message"),rc=document.querySelector(".nav__btn--home"),sc=document.querySelector(".nav__btn--library"),oc=document.querySelector(".header"),ac=document.querySelector(".buttons"),lc=document.querySelector(".movie-card"),cc=document.querySelector("[data-modal]"),hc=document.querySelector("[data-modal-close]"),uc=document.querySelector("[data-auth-close]"),dc=document.getElementById("next-page"),fc=document.getElementById("prev-page"),pc=document.querySelector(".pagination__page-buttons"),mc=document.querySelector(".pagination"),gc=document.querySelector("[data-auth]"),_c=document.querySelector(".auth__wrap"),yc=document.getElementById("txtEmail"),vc=document.getElementById("txtPassword"),wc=document.getElementById("btnLogin"),bc=document.getElementById("btnSignup"),Ic=document.getElementById("btnLogout"),Ec=document.querySelector(".auth__success-msg"),Cc=document.querySelector(".auth__logout"),Tc=document.querySelector(".btn-watched"),kc=document.querySelector(".btn-queue"),Sc=[{id:12,name:"Adventure"},{id:14,name:"Fantasy"},{id:16,name:"Animation"},{id:18,name:"Drama"},{id:27,name:"Horror"},{id:28,name:"Action"},{id:35,name:"Comedy"},{id:36,name:"History"},{id:37,name:"Western"},{id:53,name:"Thriller"},{id:80,name:"Crime"},{id:99,name:"Documentary"},{id:878,name:"Science Fiction"},{id:9648,name:"Mystery"},{id:10402,name:"Music"},{id:10749,name:"Romance"},{id:10751,name:"Family"},{id:10752,name:"War"},{id:10770,name:"TV Movie"}];ec.addEventListener("submit",(async function(e){qc(),e.preventDefault(),Ql.query=e.currentTarget.elements.searchQuery.value,ic.textContent="",nc.textContent="",""===Ql.query&&(ic.textContent="Oops, something went wrong!",Bc(),Zl.innerHTML="",mc.classList.add("hidden"));try{const{results:e,total_pages:t}=await Ql.fetchMoviesByKeyWord(1);mc.classList.remove("hidden"),0===e.length&&(nc.textContent="Search result not successful. Enter the correct movie name and",mc.classList.add("hidden")),Rc=t,pc.innerHTML="",Zl.innerHTML="",Bc(),Wc(e,Zl),Mc(1,5),Pc=!0}catch(e){console.log(e)}})),rc.addEventListener("click",(function(){Zl.innerHTML="",pc.innerHTML="",jc(),oc.classList.replace("library-header","header"),rc.parentElement.classList.add("nav__item--active"),sc.parentNode.classList.remove("nav__item--active"),ac.classList.add("hidden"),tc.classList.remove("hidden"),Xl.classList.add("home-grid"),Xl.classList.remove("library-grid")})),sc.addEventListener("click",(async function(){pc.innerHTML="",Zl.innerHTML="",oc.classList.replace("header","library-header"),sc.parentNode.classList.add("nav__item--active"),rc.parentNode.classList.remove("nav__item--active"),tc.classList.add("hidden"),ac.classList.remove("hidden"),Xl.classList.remove("home-grid"),Xl.classList.add("library-grid");try{const{results:e,total_pages:t}=await Ql.fetchTrendingMovies(1);Wc(e,Zl),Rc=t,Mc(1,5),mc.classList.remove("hidden")}catch(e){console.log(e)}})),wc.addEventListener("click",(async function(){const e=yc.value,t=vc.value;try{const s=await(n=Jl,i=e,r=t,En(J(n),ln.credential(i,r)));Ec.textContent=`You've signed in with email ${s.user.email}`}catch(e){Vl.Notify.failure(`${e.message}`)}var n,i,r;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),bc.addEventListener("click",(async function(){const e=yc.value,t=vc.value;try{const n=await Cn(Jl,e,t);Ec.textContent=`You've created account with email ${n.user.email}`}catch(e){Vl.Notify.failure(`${e.message}`)}})),Ic.addEventListener("click",(async function(){await(e=Jl,J(e).signOut());var e})),Tc.addEventListener("click",Yc),kc.addEventListener("click",Yc),dc.addEventListener("click",(function(){if(qc(),Number(xc.textContent)%5==0){const e=Number(xc.textContent)+1;return pc.innerHTML="",Mc(e,5),void(!1===Pc?Uc(e):Fc(e))}xc=xc.nextElementSibling,xc.classList.add("pagination__activ"),xc.previousElementSibling.classList.remove("pagination__activ");const e=xc.textContent;!1===Pc?Uc(e):Fc(e),Number(xc.textContent)===Rc?dc.disabled=!0:1===Number(xc.textContent)?fc.disabled=!0:fc.disabled=!1})),fc.addEventListener("click",(function(){if(qc(),(Number(xc.textContent)-1)%5==0){const e=Number(xc.textContent)-1;pc.innerHTML="";return Mc(e-5+1,5),!1===Pc?Uc(e):Fc(e),xc=pc.lastElementChild,pc.firstElementChild.classList.remove("pagination__activ"),void xc.classList.add("pagination__activ")}xc.classList.remove("pagination__activ"),xc=xc.previousElementSibling,xc.classList.add("pagination__activ");const e=xc.textContent;!1===Pc?Uc(e):Fc(e),1===Number(xc.textContent)?fc.disabled=!0:fc.disabled=!1})),pc.addEventListener("click",(function(e){if(qc(),xc.classList.remove("pagination__activ"),"BUTTON"!==e.target.nodeName)return;xc=e.target,xc.classList.add("pagination__activ");const t=xc.textContent;!1===Pc?Uc(t):Fc(t),1===Number(xc.textContent)?fc.disabled=!0:fc.disabled=!1})),rc.parentElement.classList.add("nav__item--active"),ac.classList.add("hidden"),Xl.classList.add("home-grid"),jc(),Xl.addEventListener("click",(async function(e){if("IMG"!==e.target.nodeName)return;const t=e.target.id,n=await Ql.fetchMovieInfo(t);cc.classList.remove("is-hidden"),function(e){lc.innerHTML="";const t=function(e){const t=e.genres.map((e=>e.name)).join(", "),n=Number(e.popularity).toFixed(1).toString();return`\n      <img class="movie-card__poster" src="https://image.tmdb.org/t/p/w500${e.poster_path}" id = "${e.id}" alt="${e.title}"/>\n      <div class="film-card__info">\n            <h2 class="film-card__title">${e.title}</h2>\n            <div class="film-card__details">\n                  <p>\n                        <span class="film-card__detail">Vote / Votes</span>\n                        <b class = "film-card__value"><span class="film-card__value--accent">${e.vote_average}</span>/${e.vote_count}</b>\n                   </p>\n                  <p>\n                        <span class="film-card__detail">Popularity</span>\n                        <b class = "film-card__value">${n}</b>\n                  </p>\n                  <p>\n                      <span class="film-card__detail">Original Title</span>\n                      <b class = "film-card__value film-card__value--upper">${e.original_title}</b>\n                  </p>\n                  <p>\n                      <span class="film-card__detail">Genre</span>\n                      <b class = "film-card__value">${t}</b>\n                  </p>\n            </div>\n            <h3 class="film-card__about">About</h3>\n            <p class="film-card__description">${e.overview}</p>\n            <ul class="modal__option-buttons">\n                  <button type="button" class="btn-modal" id="watched">add to Watched</button>\n                  <button type="button" class="btn-modal" id="queue">add to queue</button>\n            </ul>\n      </div>`}(e);lc.insertAdjacentHTML("beforeend",t);const n=document.getElementById("watched"),i=document.getElementById("queue");Hc=e.id,zc=e,n.addEventListener("click",Vc),i.addEventListener("click",Vc)}(n),document.addEventListener("keydown",Oc),document.addEventListener("click",Lc)})),hc.addEventListener("click",(function(){cc.classList.toggle("is-hidden")})),uc.addEventListener("click",(function(){gc.classList.toggle("is-hidden")}));let xc=null,Nc=[],Rc=0;let Pc=!1,Ac=null;function Oc(e){"Escape"===e.code&&cc.classList.add("is-hidden"),document.removeEventListener("keydown",Oc)}function Lc(e){e.target.classList.contains("backdrop")&&cc.classList.add("is-hidden")}async function Dc(){var e,t,n;e=e=>{e?(Ec.textContent=`You've entered with email ${e.email}`,_c.classList.add("hidden"),Cc.classList.remove("hidden"),uc.classList.remove("hidden"),Ac=e.uid):(_c.classList.remove("hidden"),Cc.classList.add("hidden"),uc.classList.add("hidden"))},J(Jl).onAuthStateChanged(e,t,n)}function Mc(e,t){const n=function(e,t){let n=[];for(let i=e;i<=t;i+=1)n.push(`<button type="button" class="pagination__btn page">${i}</button>`);return n.join("")}(e,e+t-1);pc.insertAdjacentHTML("beforeend",n),Nc=document.querySelectorAll(".page"),xc=Nc[0],xc.classList.add("pagination__activ")}async function Uc(e){Zl.innerHTML="";const{results:t,total_pages:n}=await Ql.fetchTrendingMovies(e);Bc(),Wc(t,Zl)}async function Fc(e){Zl.innerHTML="";const{results:t,total_pages:n}=await Ql.fetchMoviesByKeyWord(e);Bc(),Wc(t,Zl)}function qc(){document.querySelector(".spinner").classList.remove("hidden")}function Bc(){document.querySelector(".spinner").classList.add("hidden")}async function jc(){gc.classList.remove("is-hidden"),uc.classList.add("hidden"),Dc(),Bc();try{const{results:e,total_pages:t}=await Ql.fetchTrendingMovies(1);Wc(e,Zl),Rc=t,mc.classList.remove("hidden"),Mc(1,5),Pc=!1}catch(e){console.log(e)}}function Wc(e,t){const n=function(e){return e.map((e=>{let t="";var n;e.genre_ids?(n=e.genre_ids,t=Sc.filter((e=>n.includes(e.id))).map((e=>e.name)).join(", ")):t=e.genres.map((e=>e.name)).join(", ");const i=function(e){let t;return t=e?e.slice(0,4):"unknown year",t}(e.release_date);return`\n               <a class="film">\n                  <img class="film__poster" src="https://image.tmdb.org/t/p/w500${e.poster_path}" id = "${e.id}" alt="${e.title}" loading="lazy" />\n                  <div class="film__info">\n                        <p class="film__title">${e.title}</p>\n                        <p class="film__genre">${t}<span> | ${i}</span></p>\n                  </div>\n               </a>`})).join("")}(e);t.insertAdjacentHTML("beforeend",n)}let Hc=null,zc=null;function Vc(e){const t=e.currentTarget.id;Ol(Rl(Nl(Wl()),`users/${Ac}/${t}`)).then((e=>{if(e.exists()){const n=e.val();Object.values(n).map((e=>e.film)).map((e=>e.id)).includes(zc.id)||$c(Ac,zc,`/${t}`)}else $c(Ac,zc,`/${t}`)})).catch((e=>{console.error(e)}))}function $c(e,t,n){Pl(Nl(Kl,"users/"+e+`${n}`),{film:t})}function Yc(e){let t=null;e.currentTarget.classList.contains("btn-watched")&&(t=Nl(Kl,"users/"+Ac+"/watched")),e.currentTarget.classList.contains("btn-queue")&&(t=Nl(Kl,"users/"+Ac+"/queue")),Ul(t,(e=>{const t=e.val(),n=Object.values(t).map((e=>e.film)),i=document.querySelector(".library-grid");i.innerHTML="",Wc(n,i),mc.classList.add("hidden")}))}
//# sourceMappingURL=index.d331b0c9.js.map
